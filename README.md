...
# Ferramentas, bibliotecas, frameworks:
  -Ferramentas utilizadas:
    ...
    -Whatsapp(Comunicação mais dinâmica os membros do grupo responsável pela elaboração do projeto)
    
    -Discord(comunicação por áudio-call- e texto utilizada para reuniões entre os membros do grupo e para discussões acerca denaspectos do projeto)
